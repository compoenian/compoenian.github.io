...
var G__38524 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(n0) : f.call(null,n0));
var G__38524__$1 = (((G__38524 == null))?null:cljs.core.iterate((function (loc){
...
var G__38524__$2 = (((G__38524__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__38524__$1));
var G__38524__$3 = (((G__38524__$2 == null))?null:cljs.core.last(G__38524__$2));
if((G__38524__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__38524__$3);
}
} else {
return zloc;
}
...
var G__38575 = rewrite_clj.zip.move.right(v);
var G__38576 = rewrite_clj.zip.move.up(v);
loc = G__38575;
parent = G__38576;
continue;
} else {
var G__38577 = rewrite_clj.zip.move.right(v0);
var G__38578 = parent;
loc = G__38577;
parent = G__38578;
continue;
...
var G__38581 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(v));
var G__38582 = rewrite_clj.zip.move.up(v);
loc = G__38581;
parent = G__38582;
continue;
} else {
var G__38583 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__38584 = parent;
loc = G__38583;
parent = G__38584;
continue;
...
if(rewrite_clj.zip.seqz.map_QMARK_(zloc)){
var G__38562 = zloc;
var G__38562__$1 = (((G__38562 == null))?null:rewrite_clj.zip.move.down(G__38562));
var G__38562__$2 = (((G__38562__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__38562__$1,k));
if((G__38562__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__38562__$2);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__38563 = rewrite_clj.zip.move.down(zloc);
var G__38563__$1 = (((G__38563 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__38563));
if((G__38563__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__38563__$1);
}
})(),k);
}
});
