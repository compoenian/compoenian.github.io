...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__48560){
var vec__48561 = p__48560;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48561,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48561,(1),null);
...
return clojure.zip.zipper((function (p1__48565_SHARP_){
return ((cljs.core.sequential_QMARK_(p1__48565_SHARP_)) || (cljs.core.map_QMARK_(p1__48565_SHARP_)));
}),(function (x){
...
if(cljs.core.map_QMARK_(x)){
return cljs.core.with_meta(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (r,p__48567){
var vec__48568 = p__48567;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48568,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48568,(1),null);
...
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__48586_SHARP_){
return (!(cljs.core.contains_QMARK_(result,p1__48586_SHARP_)));
}),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48585_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(name),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__48585_SHARP_),"#"].join('');
...
}),mapping,cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.name,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__48590_SHARP_){
return (((p1__48590_SHARP_ instanceof cljs.core.Symbol)) && ((cljs.core.namespace(p1__48590_SHARP_) == null)));
 ...
 */
day8.re_frame.debux.common.util.with_symbols_names = (function day8$re_frame$debux$common$util$with_symbols_names(form,p__48620,mapping){
var map__48621 = p__48620;
var map__48621__$1 = cljs.core.__destructure_map(map__48621);
var state = map__48621__$1;
var context = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48621__$1,new cljs.core.Keyword(null,"context","context",-830191113));
var refers = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48621__$1,new cljs.core.Keyword(null,"refers","refers",158076809));
var aliases = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__48621__$1,new cljs.core.Keyword(null,"aliases","aliases",1346874714));
...
}),mapping,cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__48618_SHARP_){
var and__4221__auto__ = (p1__48618_SHARP_ instanceof cljs.core.Symbol);
if(and__4221__auto__){
return cljs.core.namespace(p1__48618_SHARP_);
} else {
...
var G__48726 = clojure.zip.next(clojure.zip.edit(loc,((function (loc,mapping){
return (function (sym){
...
var G__48727 = clojure.zip.next(loc);
loc = G__48727;
continue;
}
}
...
var len__4829__auto___48738 = arguments.length;
var i__4830__auto___48739 = (0);
while(true){
if((i__4830__auto___48739 < len__4829__auto___48738)){
args__4835__auto__.push((arguments[i__4830__auto___48739]));

var G__48740 = (i__4830__auto___48739 + (1));
i__4830__auto___48739 = G__48740;
continue;
} else {
}
break;
...
(day8.re_frame.debux.common.util.form_header.cljs$core$IFn$_invoke$arity$variadic = (function (form,p__48645){
var vec__48646 = p__48645;
var msg = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48646,(0),null);
...
/** @this {Function} */
(day8.re_frame.debux.common.util.form_header.cljs$lang$applyTo = (function (seq48643){
var G__48644 = cljs.core.first(seq48643);
var seq48643__$1 = cljs.core.next(seq48643);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__48644,seq48643__$1);
}));

day8.re_frame.debux.common.util.prepend_blanks = (function day8$re_frame$debux$common$util$prepend_blanks(lines){
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__48650_SHARP_){
return ["  ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__48650_SHARP_)].join('');
}),lines);
});
...
var _STAR_print_newline_STAR__orig_val__48660_48741 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__48661_48742 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__48662_48743 = true;
var _STAR_print_fn_STAR__temp_val__48663_48744 = (function (x__4761__auto__){
return sb__4760__auto__.append(x__4761__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__48662_48743);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__48663_48744);

try{cljs.pprint.pprint.cljs$core$IFn$_invoke$arity$1(res);
}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__48661_48742);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__48660_48741);
}
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(sb__4760__auto__);
})();
var pprint = clojure.string.trim(result__$1);
cljs.core.println.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([clojure.string.join.cljs$core$IFn$_invoke$arity$2("\n",cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__48653_SHARP_){
return day8.re_frame.debux.common.util.prepend_bars(p1__48653_SHARP_,indent_level);
...
if(typeof f === 'number'){
var G__48748 = cljs.core.next(opts__$1);
var G__48749 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"n","n",562130025),f);
opts__$1 = G__48748;
acc = G__48749;
continue;
} else {
if(typeof f === 'string'){
var G__48750 = cljs.core.next(opts__$1);
var G__48751 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"msg","msg",-1386103444),f);
opts__$1 = G__48750;
acc = G__48751;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"if","if",-458814265))){
var G__48752 = cljs.core.nnext(opts__$1);
var G__48753 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"condition","condition",1668437652),s);
opts__$1 = G__48752;
acc = G__48753;
continue;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(f,new cljs.core.Keyword(null,"js","js",1768080579))){
var G__48754 = cljs.core.next(opts__$1);
var G__48755 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"js","js",1768080579),true);
opts__$1 = G__48754;
acc = G__48755;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__48676 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"o","o",-1350007228),null,new cljs.core.Keyword(null,"once","once",-262568523),null], null), null);
return (fexpr__48676.cljs$core$IFn$_invoke$arity$1 ? fexpr__48676.cljs$core$IFn$_invoke$arity$1(f) : fexpr__48676.call(null,f));
})())){
var G__48756 = cljs.core.next(opts__$1);
var G__48757 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"once","once",-262568523),true);
opts__$1 = G__48756;
acc = G__48757;
continue;
} else {
if(cljs.core.truth_((function (){var fexpr__48677 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"s","s",1705939918),null,new cljs.core.Keyword(null,"style","style",-496642736),null], null), null);
return (fexpr__48677.cljs$core$IFn$_invoke$arity$1 ? fexpr__48677.cljs$core$IFn$_invoke$arity$1(f) : fexpr__48677.call(null,f));
})())){
var G__48759 = cljs.core.nnext(opts__$1);
var G__48760 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"style","style",-496642736),s);
opts__$1 = G__48759;
acc = G__48760;
continue;
} else {
...
var G__48762 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(acc,new cljs.core.Keyword(null,"clog","clog",954273629),true);
opts__$1 = G__48761;
acc = G__48762;
continue;
} else {
...
day8.re_frame.debux.common.util.quote_val = (function day8$re_frame$debux$common$util$quote_val(p__48683){
...
var G__48689 = new cljs.core.Symbol(null,"recur","recur",1202958259,null);
var fexpr__48688 = cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.set,cljs.core.flatten)(form);
return (fexpr__48688.cljs$core$IFn$_invoke$arity$1 ? fexpr__48688.cljs$core$IFn$_invoke$arity$1(G__48689) : fexpr__48688.call(null,G__48689));
});
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__48692 = quoted_form;
var G__48693 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__48692,G__48693) : day8.re_frame.debux.common.util.remove_d.call(null,G__48692,G__48693));
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__48698 = quoted_form;
var G__48699 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__48698,G__48699) : day8.re_frame.debux.common.util.remove_d.call(null,G__48698,G__48699));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
return (function() { 
var G__48764__delegate = function (arg){
...
day8.re_frame.debux.common.util.send_trace_BANG_(new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"form","form",-1624062471),(function (){var G__48705 = quoted_form;
var G__48706 = new cljs.core.Symbol(null,"dummy","dummy",-594669915,null);
return (day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2 ? day8.re_frame.debux.common.util.remove_d.cljs$core$IFn$_invoke$arity$2(G__48705,G__48706) : day8.re_frame.debux.common.util.remove_d.call(null,G__48705,G__48706));
})(),new cljs.core.Keyword(null,"result","result",1415092211),result,new cljs.core.Keyword(null,"indent-level","indent-level",-258835684),indent], null));
...
var G__48769__i = 0, G__48769__a = new Array(arguments.length -  0);
while (G__48769__i < G__48769__a.length) {G__48769__a[G__48769__i] = arguments[G__48769__i + 0]; ++G__48769__i;}
  arg = new cljs.core.IndexedSeq(G__48769__a,0,null);
} 
return G__48764__delegate.call(this,arg);};
G__48764.cljs$lang$maxFixedArity = 0;
G__48764.cljs$lang$applyTo = (function (arglist__48770){
var arg = cljs.core.seq(arglist__48770);
return G__48764__delegate(arg);
});
...
var G__48772 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__48772;
continue;
} else {
...
var G__48773 = clojure.zip.replace(loc,cljs.core.last(node));
loc = G__48773;
continue;
} else {
var G__48774 = clojure.zip.next(loc);
loc = G__48774;
continue;
