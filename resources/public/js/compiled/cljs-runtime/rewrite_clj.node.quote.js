...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4474__auto__,k37445,else__4475__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k37445,else__4475__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4495__auto__,p__37461){
var vec__37462 = p__37461;
var k__4496__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37462,(0),null);
var v__4497__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37462,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__37444){
var self__ = this;
var G__37444__$1 = this;
return (new cljs.core.RecordIter((0),G__37444__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this37446,other37447){
var self__ = this;
var this37446__$1 = this;
return (((!((other37447 == null)))) && ((((this37446__$1.constructor === other37447.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37446__$1.tag,other37447.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37446__$1.prefix,other37447.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37446__$1.sym,other37447.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37446__$1.children,other37447.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this37446__$1.__extmap,other37447.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__4479__auto__,k37445){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k37445);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4480__auto__,k__4481__auto__,G__37444){
var self__ = this;
var this__4480__auto____$1 = this;
var pred__37499 = cljs.core.keyword_identical_QMARK_;
var expr__37500 = k__4481__auto__;
if(cljs.core.truth_((pred__37499.cljs$core$IFn$_invoke$arity$2 ? pred__37499.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__37500) : pred__37499.call(null,new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__37500)))){
return (new rewrite_clj.node.quote.QuoteNode(G__37444,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37499.cljs$core$IFn$_invoke$arity$2 ? pred__37499.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__37500) : pred__37499.call(null,new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__37500)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__37444,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37499.cljs$core$IFn$_invoke$arity$2 ? pred__37499.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__37500) : pred__37499.call(null,new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__37500)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__37444,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__37499.cljs$core$IFn$_invoke$arity$2 ? pred__37499.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__37500) : pred__37499.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__37500)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__37444,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4481__auto__,G__37444),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4471__auto__,G__37444){
var self__ = this;
var this__4471__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__37444,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__37453){
var extmap__4512__auto__ = (function (){var G__37503 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__37453,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
...
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__37453),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__37453),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__37453),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__37453),null,cljs.core.not_empty(extmap__4512__auto__),null));
});
...
var G__37531 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__37531;
continue;
}
break;
...
var G__37532 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__37532;
continue;
}
break;
...
var G__37533 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__37533;
continue;
}
break;
...
var G__37534 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__37534;
continue;
}
break;
