...
var temp__5751__auto____$1 = (o27735["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o27736 = temp__5751__auto____$1;
return (o27736["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27355__auto__ = f;
return (o__27355__auto__["toString"]).call(o__27355__auto__);
} else {
return "";
}
...
try{var o__27355__auto___27965 = t;
(o__27355__auto___27965["cljs$lang$ctorPrWriter"]).call(o__27355__auto___27965,t,writer);
}catch (e27748){var __27966 = e27748;
}
...
var char_code = (function (){var o__27355__auto__ = (new String(char$));
return (o__27355__auto__["charCodeAt"]).call(o__27355__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27355__auto__ = String;
return (o__27355__auto__["fromCharCode"]).call(o__27355__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__27752 = num_code;
switch (G__27752) {
case (1):
return (185);
...
var o__27355__auto__ = String;
return (o__27355__auto__["fromCharCode"]).call(o__27355__auto__,superscript_code);
});
/**
...
}catch (e27767){var _e__27375__auto__ = e27767;
return false;
}})())){
...
var vec__27770 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27770,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__27780){
var vec__27781 = p__27780;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27781,(0),null);
...
var G__27989 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__27990 = cljs.core.butlast(remaining_tokens);
name_tokens = G__27989;
remaining_tokens = G__27990;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq27778){
var G__27779 = cljs.core.first(seq27778);
var seq27778__$1 = cljs.core.next(seq27778);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27779,seq27778__$1);
}));
...
var vec__27792 = cljs.core.split_with((function (p1__27788_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__27788_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27792,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27792,(1),null);
...
var vec__27799 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27799,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27799,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__27992 = cljs.core.rest(remaining_tokens);
var G__27993 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__27992;
name_tokens = G__27993;
continue;
} else {
...
var vec__27808 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27808,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27808,(1),null);
var vec__27811 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27811,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27811,(1),null);
var vec__27814 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27814,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27814,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27814,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27814,(3),null);
...
var vec__27819 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27819,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27819,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27819,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27819,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27819,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27819,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__27822 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27822,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27822,(1),null);
var vec__27825 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27825,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27825,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__27832 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__27832) : devtools.munging.parse_fn_info_deep.call(null,G__27832));
})()));
}
} else {
return fn_info;
...
var G__28002 = (arity + (1));
var G__28003 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27847,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27847,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27861_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__27861_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27862_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__27862_SHARP_);
}),sorted_infos);
...
var G__28008 = (i__4830__auto___28006 + (1));
i__4830__auto___28006 = G__28008;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__27866){
var vec__27867 = p__27866;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27867,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq27864){
var G__27865 = cljs.core.first(seq27864);
var seq27864__$1 = cljs.core.next(seq27864);
var self__4816__auto__ = this;
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27865,seq27864__$1);
}));
...
var map__27888 = options;
var map__27888__$1 = cljs.core.__destructure_map(map__27888);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27888__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27888__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27888__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27888__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__27889 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27889,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27889,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27889,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27889,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27889,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27889,(5),null);
...
var o__27355__auto__ = f;
return (o__27355__auto__["getBasis"]).call(o__27355__auto__);
});
/**
...
}catch (e27907){var _e__27375__auto__ = e27907;
...
var G__28029 = (obj[cljs.core.first(path)]);
var G__28030 = cljs.core.rest(path);
obj = G__28029;
path = G__28030;
continue;
} else {
...
var _STAR_ = (function (accum,p__27917){
var vec__27918 = p__27917;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27918,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27918,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__27932){
var vec__27933 = p__27932;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27933,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27933,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27933,(2),null);
...
var post_process = (function (p__27947){
var vec__27948 = p__27947;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27948,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27948,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__27946_SHARP_){
return (obj[cljs.core.first(p1__27946_SHARP_)]);
}),sorted_matches);
