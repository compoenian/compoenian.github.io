...
var G__34824 = o;
goog.object.set(G__34824,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__34852__i < G__34852__a.length) {G__34852__a[G__34852__i] = arguments[G__34852__i + 0]; ++G__34852__i;}
  args = new cljs.core.IndexedSeq(G__34852__a,0,null);
} 
...
var G__34825 = o;
goog.object.set(G__34825,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__34856__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__34857__i < G__34857__a.length) {G__34857__a[G__34857__i] = arguments[G__34857__i + 0]; ++G__34857__i;}
  args = new cljs.core.IndexedSeq(G__34857__a,0,null);
} 
return G__34856__delegate.call(this,args);};
G__34856.cljs$lang$maxFixedArity = 0;
G__34856.cljs$lang$applyTo = (function (arglist__34858){
var args = cljs.core.seq(arglist__34858);
return G__34856__delegate(args);
});
...
var G__34826 = props;
var G__34826__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34826,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__34826);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34826__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4223__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__34827 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__34827,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__34827;
}
})(),id_class);
...
var G__34828 = (cljs.core.count(argv) - first_child);
switch (G__34828) {
case (0):
...
var vec__34829 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34829,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34829,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34829,(2),null);
...
var temp__5757__auto___34864 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___34864 == null)){
} else {
var key_34865 = temp__5757__auto___34864;
(jsprops.key = key_34865);
}
...
var temp__5757__auto___34866 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___34866 == null)){
} else {
var key_34867 = temp__5757__auto___34866;
(jsprops.key = key_34867);
}
...
var temp__5757__auto___34871 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___34871 == null)){
} else {
var key_34872 = temp__5757__auto___34871;
(jsprops.key = key_34872);
}
...
var temp__5757__auto___34875 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___34875 == null)){
} else {
var key_34876 = temp__5757__auto___34875;
(jsprops.key = key_34876);
}
...
var temp__5757__auto___34877 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___34877 == null)){
} else {
var key_34878 = temp__5757__auto___34877;
(jsprops.key = key_34878);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34838_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__34838_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__34842 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34842,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__34842,(1),null);
...
break;
default:
var G__34885 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__34886 = compiler;
v = G__34885;
compiler = G__34886;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template34848 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template34848 = (function (opts,id,fn_to_element,parse_fn,meta34849){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template34848.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_34850,meta34849__$1){
var self__ = this;
var _34850__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template34848(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta34849__$1));
}));

(reagent.impl.template.t_reagent$impl$template34848.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_34850){
var self__ = this;
var _34850__$1 = this;
return self__.meta34849;
}));

(reagent.impl.template.t_reagent$impl$template34848.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template34848.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template34848.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template34848.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template34848.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template34848.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta34849","meta34849",979392243,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template34848.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template34848.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template34848");

(reagent.impl.template.t_reagent$impl$template34848.cljs$lang$ctorPrWriter = (function (this__4461__auto__,writer__4462__auto__,opt__4463__auto__){
return cljs.core._write(writer__4462__auto__,"reagent.impl.template/t_reagent$impl$template34848");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template34848.
 */
reagent.impl.template.__GT_t_reagent$impl$template34848 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template34848(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta34849){
return (new reagent.impl.template.t_reagent$impl$template34848(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta34849));
});

}

return (new reagent.impl.template.t_reagent$impl$template34848(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
