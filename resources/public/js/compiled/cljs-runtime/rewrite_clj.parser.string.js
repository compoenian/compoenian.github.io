...
if((c === "\n")){
var G__38136 = escape_QMARK_;
var G__38137 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__38136;
lines = G__38137;
continue;
} else {
buf.append(c);

var G__38138 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__38139 = lines;
escape_QMARK_ = G__38138;
lines = G__38139;
continue;
...
var G__38123 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__38123) : rewrite_clj.node.string_node.call(null,G__38123));
});
...
var G__38128 = cljs.core.re_pattern(regex);
var G__38129 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__38128,G__38129) : rewrite_clj.node.token_node.call(null,G__38128,G__38129));
});
