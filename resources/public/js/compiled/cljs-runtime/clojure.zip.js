...
var G__38157 = clojure.zip.node(loc);
var fexpr__38156 = new cljs.core.Keyword("zip","branch?","zip/branch?",-998880862).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__38156.cljs$core$IFn$_invoke$arity$1 ? fexpr__38156.cljs$core$IFn$_invoke$arity$1(G__38157) : fexpr__38156.call(null,G__38157));
});
/**
...
var G__38159 = clojure.zip.node(loc);
var fexpr__38158 = new cljs.core.Keyword("zip","children","zip/children",-940194589).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__38158.cljs$core$IFn$_invoke$arity$1 ? fexpr__38158.cljs$core$IFn$_invoke$arity$1(G__38159) : fexpr__38158.call(null,G__38159));
} else {
...
var fexpr__38161 = new cljs.core.Keyword("zip","make-node","zip/make-node",1103800591).cljs$core$IFn$_invoke$arity$1(cljs.core.meta(loc));
return (fexpr__38161.cljs$core$IFn$_invoke$arity$2 ? fexpr__38161.cljs$core$IFn$_invoke$arity$2(node,children) : fexpr__38161.call(null,node,children));
});
/**
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_(loc))){
var vec__38163 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38163,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38163,(1),null);
var vec__38166 = clojure.zip.children(loc);
...
var vec__38171 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38171,(0),null);
var map__38174 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38171,(1),null);
var map__38174__$1 = cljs.core.__destructure_map(map__38174);
var path = map__38174__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38174__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38174__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38174__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38174__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var changed_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38174__$1,new cljs.core.Keyword(null,"changed?","changed?",-437828330));
...
var vec__38179 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38179,(0),null);
var map__38182 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38179,(1),null);
var map__38182__$1 = cljs.core.__destructure_map(map__38182);
var path = map__38182__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38182__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var vec__38183 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38182__$1,new cljs.core.Keyword(null,"r","r",-471384190));
...
var vec__38189 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38189,(0),null);
var map__38192 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38189,(1),null);
var map__38192__$1 = cljs.core.__destructure_map(map__38192);
var path = map__38192__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38192__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38192__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
return r;
} else {
...
var vec__38194 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38194,(0),null);
var map__38197 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38194,(1),null);
var map__38197__$1 = cljs.core.__destructure_map(map__38197);
var path = map__38197__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38197__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38197__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
...
var vec__38198 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38198,(0),null);
var map__38202 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38198,(1),null);
...
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38202__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if(cljs.core.truth_((function (){var and__4221__auto__ = path;
if(cljs.core.truth_(and__4221__auto__)){
return cljs.core.seq(l);
} else {
...
var vec__38211 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38211,(0),null);
var map__38214 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38211,(1),null);
var map__38214__$1 = cljs.core.__destructure_map(map__38214);
var path = map__38214__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38214__$1,new cljs.core.Keyword(null,"l","l",1395893423));
if((path == null)){
throw "Insert at top";
} else {
...
var vec__38220 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38220,(0),null);
var map__38223 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38220,(1),null);
var map__38223__$1 = cljs.core.__destructure_map(map__38223);
var path = map__38223__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38223__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Insert at top";
} else {
...
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38226,(1),null);
...
var len__4829__auto___38303 = arguments.length;
var i__4830__auto___38304 = (0);
while(true){
if((i__4830__auto___38304 < len__4829__auto___38303)){
args__4835__auto__.push((arguments[i__4830__auto___38304]));

var G__38305 = (i__4830__auto___38304 + (1));
i__4830__auto___38304 = G__38305;
continue;
} else {
}
break;
...
/** @this {Function} */
(clojure.zip.edit.cljs$lang$applyTo = (function (seq38229){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38230,G__38231,seq38229__$2);
}));
...
var G__38309 = clojure.zip.rightmost(child);
loc__$1 = G__38309;
continue;
} else {
return loc__$1;
...
var vec__38281 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38281,(0),null);
var map__38284 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38281,(1),null);
var map__38284__$1 = cljs.core.__destructure_map(map__38284);
var path = map__38284__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38284__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38284__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38284__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38284__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
throw "Remove at top";
} else {
...
var G__38310 = clojure.zip.rightmost(child);
loc__$1 = G__38310;
continue;
} else {
return loc__$1;
