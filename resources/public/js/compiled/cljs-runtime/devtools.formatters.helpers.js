...
var G__28021 = devtools.prefs.pref(v);
v = G__28021;
continue;
} else {
return v;
...
}catch (e27980){var _e__27375__auto__ = e27980;
return false;
}})();
...
}catch (e27982){var _e__27375__auto__ = e27982;
return false;
}})();
...
}catch (e27984){var _e__27375__auto__ = e27984;
return false;
}}
}
});
...
var vec__27997 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27997,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27997,(1),null);
...
return cljs.core.some((function (p1__28001_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28001_SHARP_);
}),template);
});
