...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__38354,k,f){
var vec__38355 = p__38354;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38355,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38355,(1),null);
var loc = vec__38355;
...
var G__38436 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__38436;
continue;
}
break;
...
var G__38437 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__38437;
continue;
} else {
return zloc__$1;
...
var G__38438 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__38438;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__38382){
var vec__38383 = p__38382;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38383,(0),null);
var map__38386 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38383,(1),null);
var map__38386__$1 = cljs.core.__destructure_map(map__38386);
var path = map__38386__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38386__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__38383;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__38410){
var vec__38414 = p__38410;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38414,(0),null);
var map__38417 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38414,(1),null);
var map__38417__$1 = cljs.core.__destructure_map(map__38417);
var path = map__38417__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38417__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__38414;
if(cljs.core.seq(r)){
...
var vec__38426 = loc;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38426,(0),null);
var map__38429 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__38426,(1),null);
var map__38429__$1 = cljs.core.__destructure_map(map__38429);
var path = map__38429__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38429__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var ppath = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38429__$1,new cljs.core.Keyword(null,"ppath","ppath",-1758182784));
var pnodes = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38429__$1,new cljs.core.Keyword(null,"pnodes","pnodes",1739080565));
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38429__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
