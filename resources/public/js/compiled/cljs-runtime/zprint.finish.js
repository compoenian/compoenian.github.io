...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__37160_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__37160_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__37160_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__37167){
var vec__37168 = p__37167;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37168,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37168,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__37179,s,color,element,idx){
var map__37180 = p__37179;
var map__37180__$1 = cljs.core.__destructure_map(map__37180);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37180__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37180__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37180__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__37186 = (function (){var or__4223__auto__ = color;
...
var fexpr__37185 = (function (){var G__37188 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__37188) : style_map.call(null,G__37188));
})();
return (fexpr__37185.cljs$core$IFn$_invoke$arity$1 ? fexpr__37185.cljs$core$IFn$_invoke$arity$1(G__37186) : fexpr__37185.call(null,G__37186));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__37201){
var vec__37202 = p__37201;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37202,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37202,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37202,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__37209){
var vec__37210 = p__37209;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37210,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37210,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37210,(2),null);
...
var G__37337 = cljs.core.next(ssv);
var G__37338 = (this_ssv == null);
var G__37339 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
...
var vec__37229 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37229,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37229,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37229,(2),null);
...
var G__37341 = cljs.core.next(remaining_cvec);
var G__37342 = new_idx;
var G__37343 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__37341;
idx = G__37342;
out = G__37343;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__37256,cursor_vec){
var vec__37257 = p__37256;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37257,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37257,(1),null);
var focus_vec = vec__37257;
...
var vec__37268 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37268,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37268,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__37276){
var vec__37277 = p__37276;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37277,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37277,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__37290,existing_count){
var vec__37291 = p__37290;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37291,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37291,(1),null);
...
return cljs.core.filterv((function (p1__37287_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__37287_SHARP_))));
...
var vec__37308 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37308,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37308,(1),null);
var cvec_element = vec__37308;
if((cvec_element == null)){
var G__37356 = cljs.core.next(cvec_nl);
var G__37357 = (idx + (1));
var G__37358 = start;
var G__37359 = out;
cvec_nl = G__37356;
...
var G__37360 = cljs.core.next(cvec_nl);
var G__37361 = (idx + (1));
var G__37362 = idx;
var G__37363 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__37360;
idx = G__37361;
start = G__37362;
out = G__37363;
...
var G__37364 = cljs.core.next(cvec_nl);
var G__37365 = (idx + (1));
var G__37366 = (idx + (1));
var G__37367 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__37364;
idx = G__37365;
start = G__37366;
out = G__37367;
...
var G__37368 = cljs.core.next(cvec_nl);
var G__37369 = (idx + (1));
var G__37370 = idx;
var G__37371 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__37368;
idx = G__37369;
start = G__37370;
out = G__37371;
...
var G__37373 = cljs.core.next(cvec_nl);
var G__37374 = (idx + (1));
var G__37375 = start;
var G__37376 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__37373;
idx = G__37374;
start = G__37375;
out = G__37376;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__37314_SHARP_,p2__37313_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__37313_SHARP_)){
return cljs.core.reduced(p1__37314_SHARP_);
} else {
return (p1__37314_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__37319,p__37320){
var vec__37321 = p__37319;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37321,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37321,(1),null);
var vec__37324 = p__37320;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37324,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__37324,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__37331,cvec,focus_vec){
var map__37332 = p__37331;
var map__37332__$1 = cljs.core.__destructure_map(map__37332);
var options = map__37332__$1;
var map__37333 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37332__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__37333__$1 = cljs.core.__destructure_map(map__37333);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37333__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37333__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__37333__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__37330_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__37330_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
