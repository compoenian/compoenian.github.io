...
var G__39247 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__39247;
continue;
} else {
var G__39248 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__39248;
continue;
}
} else {
var G__39249 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__39249;
continue;
}
}
...
var G__39163 = zloc;
var G__39164 = (function (){var G__39165 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__39166 = zloc;
var G__39166__$1 = (((G__39166 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__39166) : rewrite_clj.zip.node.call(null,G__39166)));
if((G__39166__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__39166__$1) : zprint.zutil.edn_STAR_.call(null,G__39166__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__39165) : rewrite_clj.zip.root.call(null,G__39165));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__39163,G__39164) : rewrite_clj.zip.replace.call(null,G__39163,G__39164));
});
/**
...
var G__39259 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__39259;
continue;
}
break;
...
var G__39260 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__39261 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__39260;
out = G__39261;
continue;
} else {
...
var G__39265 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__39266 = cljs.core.next(new_loc);
var G__39267 = replaced_loc;
nloc = G__39265;
new_loc = G__39266;
last_loc = G__39267;
continue;
...
return zprint.rewrite.sort_val((function (){var G__39216 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__39216) : rewrite_clj.zip.down.call(null,G__39216));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__39220_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__39220_SHARP_) : rewrite_clj.zip.tag.call(null,p1__39220_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__39220_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__39220_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
