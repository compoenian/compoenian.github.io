...
var len__4829__auto___28176 = arguments.length;
var i__4830__auto___28177 = (0);
while(true){
if((i__4830__auto___28177 < len__4829__auto___28176)){
args__4835__auto__.push((arguments[i__4830__auto___28177]));

var G__28178 = (i__4830__auto___28177 + (1));
i__4830__auto___28177 = G__28178;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28041){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28042,G__28043,seq28041__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28081_SHARP_){
return (!((cljs.core.meta(p1__28081_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28104__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28108){var _e__27375__auto__ = e28108;
return false;
}})();
if(cljs.core.truth_(or__4223__auto__)){
return or__4223__auto__;
...
}catch (e28111){var _e__27375__auto__ = e28111;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28127 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28128 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28128);

try{var map__28132 = opts;
var map__28132__$1 = cljs.core.__destructure_map(map__28132);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28132__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28127);
}});
...
var temp__5751__auto___28211 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___28211)){
var managed_print_level_28212 = temp__5751__auto___28211;
var _STAR_print_level_STAR__orig_val__28140_28213 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28141_28214 = managed_print_level_28212;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28141_28214);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28135_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28135_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28140_28213);
}} else {
job_fn();
}
