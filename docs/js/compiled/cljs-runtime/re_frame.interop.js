...
return [(function (){var pred__34975 = cljs.core.instance_QMARK_;
var expr__34976 = reactive_val;
if(cljs.core.truth_((pred__34975.cljs$core$IFn$_invoke$arity$2 ? pred__34975.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__34976) : pred__34975.call(null,reagent.ratom.RAtom,expr__34976)))){
return "ra";
} else {
if(cljs.core.truth_((pred__34975.cljs$core$IFn$_invoke$arity$2 ? pred__34975.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__34976) : pred__34975.call(null,reagent.ratom.RCursor,expr__34976)))){
return "rc";
} else {
if(cljs.core.truth_((pred__34975.cljs$core$IFn$_invoke$arity$2 ? pred__34975.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__34976) : pred__34975.call(null,reagent.ratom.Reaction,expr__34976)))){
return "rx";
} else {
if(cljs.core.truth_((pred__34975.cljs$core$IFn$_invoke$arity$2 ? pred__34975.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__34976) : pred__34975.call(null,reagent.ratom.Track,expr__34976)))){
return "tr";
} else {
return "other";
}
