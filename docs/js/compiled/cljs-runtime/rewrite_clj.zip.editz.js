...
var G__38466 = (function (){var G__38467 = (rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.sexpr.cljs$core$IFn$_invoke$arity$1(node) : rewrite_clj.node.sexpr.call(null,node));
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__38467) : f.call(null,G__38467));
})();
return (rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.coerce.cljs$core$IFn$_invoke$arity$1(G__38466) : rewrite_clj.node.coerce.call(null,G__38466));
});
/**
...
var len__4829__auto___38506 = arguments.length;
var i__4830__auto___38507 = (0);
while(true){
if((i__4830__auto___38507 < len__4829__auto___38506)){
args__4835__auto__.push((arguments[i__4830__auto___38507]));

var G__38508 = (i__4830__auto___38507 + (1));
i__4830__auto___38507 = G__38508;
continue;
} else {
}
break;
...
return clojure.zip.edit.cljs$core$IFn$_invoke$arity$variadic(zloc,rewrite_clj.zip.editz.edit_node,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (p1__38468_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(f,p1__38468_SHARP_,args);
})], 0));
}));
...
/** @this {Function} */
(rewrite_clj.zip.editz.edit.cljs$lang$applyTo = (function (seq38469){
...
return self__4816__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38470,G__38471,seq38469__$2);
}));
...
var e_SINGLEQUOTE_ = ((typeof e === 'string')?(str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(e) : str_fn.call(null,e)):(((e instanceof cljs.core.Keyword))?cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__38480 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__38480) : str_fn.call(null,G__38480));
})()):(((e instanceof cljs.core.Symbol))?cljs.core.symbol.cljs$core$IFn$_invoke$arity$2(cljs.core.namespace(e),(function (){var G__38481 = cljs.core.name(e);
return (str_fn.cljs$core$IFn$_invoke$arity$1 ? str_fn.cljs$core$IFn$_invoke$arity$1(G__38481) : str_fn.call(null,G__38481));
})()):null)));
...
var G__38499 = rewrite_clj.zip.base.tag(zloc);
var G__38499__$1 = (((G__38499 instanceof cljs.core.Keyword))?G__38499.fqn:null);
switch (G__38499__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__38497_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__38497_SHARP_)].join('');
}));
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(lines,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0)], null),(function (p1__38498_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s),cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__38498_SHARP_)].join('');
}));
}
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38499__$1)].join('')));

}
});
rewrite_clj.zip.editz.suffix = (function rewrite_clj$zip$editz$suffix(zloc,s){
var G__38503 = rewrite_clj.zip.base.tag(zloc);
var G__38503__$1 = (((G__38503 instanceof cljs.core.Keyword))?G__38503.fqn:null);
switch (G__38503__$1) {
case "token":
return rewrite_clj.zip.editz.edit_token(zloc,(function (p1__38500_SHARP_){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__38500_SHARP_),cljs.core.str.cljs$core$IFn$_invoke$arity$1(s)].join('');
}));
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__38503__$1)].join('')));
