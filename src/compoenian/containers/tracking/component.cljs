(ns compoenian.containers.tracking.component
  (:require
   ...
   ["@material-ui/icons" :refer [Mood PlayArrow Pause Clear Eject Folder LocalAtm DirectionsRun Help Redeem DoubleArrow]]
       ...
       [:> mui/Grid {:container true
        ...
        [:> mui/Grid {:item true}
         [:> mui/Box {:class (styles/current-zone-container)}
          ...
          [:> mui/Box {:class (styles/stat-value)} "TWILIGHT STRAND"]]]
        [:> mui/Grid {:item true}
         [:> mui/Box {}
        ...
        [:> mui/Grid {:item true}
         [:> mui/Box {:class (styles/current-zone-container)}
          ...
          [:> mui/Box {:class (styles/stat-value)} "LIONEYE'S WATCH"]]]]]
      [:> mui/Grid {:item true}
       [:> mui/Box {}
        [:> mui/Grid {:container true
                      :direction "column"
