...
var i_43104 = (0);
while(true){
if((i_43104 < arr.length)){
(arr[i_43104] = null);

var G__43105 = (i_43104 + (1));
i_43104 = G__43105;
continue;
} else {
}
...
var i_43113 = (self__.level + (1));
while(true){
if((i_43113 <= (new_level + (1)))){
(update[i_43113] = self__.header);

var G__43119 = (i_43113 + (1));
i_43113 = G__43119;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_43120 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_43120[i]));
} else {
x__$2.forward.push((((i < links_43120.length))?(links_43120[i]):null));
}

if((i < links_43120.length)){
(links_43120[i] = x__$2);
} else {
links_43120.push(x__$2);
}
...
var i_43126 = (0);
while(true){
if((i_43126 <= self__.level)){
var links_43127 = (update[i_43126]).forward;
if((x__$1 === (((i_43126 < links_43127.length))?(links_43127[i_43126]):null))){
(links_43127[i_43126] = (x__$1.forward[i_43126]));

var G__43128 = (i_43126 + (1));
i_43126 = G__43128;
continue;
} else {
var G__43129 = (i_43126 + (1));
i_43126 = G__43129;
continue;
}
} else {
...
var G__43135 = nx;
var G__43136 = (level__$1 - (1));
x = G__43135;
level__$1 = G__43136;
continue;
} else {
var G__43137 = x;
var G__43138 = (level__$1 - (1));
x = G__43137;
level__$1 = G__43138;
continue;
}
